...
class FrameRecommend(tk.Frame):
    def __init__(self, master):
        ...
        # To make all the frames within the Recommend tab
        ...
        self.frame_inputs.grid(row=0, column=0, padx=[pad_ext, pad_ext-1], pady=pad_ext, sticky='n')
        ...
        self.label_spd.grid(row=5, column=0, padx=pad_ext, pady=[5*pad_ext, pad_ext], sticky='w')
        self.entry_spd.grid(row=5, column=1, padx=pad_ext, pady=[5*pad_ext, pad_ext])
        self.label_spd_updown.grid(row=5, column=2, padx=pad_ext, pady=[5*pad_ext, pad_ext])
        self.entry_spd_tol.grid(row=5, column=3, padx=pad_ext, pady=[5*pad_ext, pad_ext])
        self.label_spd_perc.grid(row=5, column=4, padx=[0, pad_ext], pady=[5*pad_ext, pad_ext])
        self.label_trq.grid(row=6, column=0, padx=pad_ext, pady=pad_ext, sticky='w')
        self.entry_trq.grid(row=6, column=1, padx=pad_ext, pady=pad_ext)
        self.label_trq_updown.grid(row=6, column=2, padx=pad_ext, pady=pad_ext)
        self.entry_trq_tol.grid(row=6, column=3, padx=pad_ext, pady=pad_ext)
        self.label_trq_perc.grid(row=6, column=4, padx=[0, pad_ext], pady=pad_ext)
        self.label_safety.grid(row=7, column=0, padx=pad_ext, pady=pad_ext, sticky='w')
        self.entry_safety_low.grid(row=7, column=1, padx=pad_ext, pady=pad_ext)
        self.entry_safety_high.grid(row=7, column=3, padx=pad_ext, pady=pad_ext)
        self.label_lower.grid(row=8, column=1, padx=pad_ext, pady=pad_ext)
        self.label_upper.grid(row=8, column=3, padx=pad_ext, pady=pad_ext)
        ...
        # Widgets in the Recommend tab output frame
