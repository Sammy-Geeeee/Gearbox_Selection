...
class FrameCheck(tk.Frame):
    ...
    # To position all the widgets within the grid
        ...
        self.label_ratio.grid(row=4, column=0, padx=pad_ext, pady=pad_ext)
        self.entry_ratio.grid(row=4, column=1, padx=pad_ext, pady=pad_ext)
        self.label_pwr.grid(row=5, column=0, padx=pad_ext, pady=pad_ext)
        self.entry_pwr.grid(row=5, column=1, padx=pad_ext, pady=pad_ext)
